...
function MainAppContent() {
    ...
    const renderModule = () => {
        switch (activeModule) {
            ...
            case 'music': return <div className="module-container"><button className="module-button" onClick={() => setActiveModule('home')}>Voltar</button></div>;
                ...
                return (
                    <>
                        ...
                        <div className="windows-grid">
                            ...
                            <div className="app-window" onClick={() => setActiveModule('music')}>🎵 Lista de Músicas</div>
